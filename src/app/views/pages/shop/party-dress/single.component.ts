...
@Component({
  selector: 'app-single-party-dress',
  standalone: true,
  imports: [
    BreadcrumbComponent,
    HeroComponent,
...
export class PartyDressComponent implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    // Set the page title
    this.titleService.setTitle('Rent a Party Dress | Fizoillu')

    // Set meta description
    this.metaService.addTag({
      name: 'description',
      content:
        'You can now rent a chic party dress for your upcoming celebration from Fizoillu. Explore the color options to choose the perfect one for your child.',
    })
  }
  productGridList = productGrid
  productImages = products[5].images
  currency = currency
